...
public class ItemRequestRepositoryTest {
    ...
    void findAllByRequestorNotLikeOrderByCreatedAscTest() {
        ...
        Page<ItemRequest> list = itemRequestRepository
                .findAllByRequestorIdIsNotOrderByCreatedDesc(user1.getId(), PageRequest.of(0,10));

        assertEquals(itemRequest2.getDescription(), list.get().collect(Collectors.toList()).get(0).getDescription());
    }
}
