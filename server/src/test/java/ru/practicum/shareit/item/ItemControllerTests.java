...
public class ItemControllerTests {
    ...
    @Test
    void createTest() {
        ResponseEntity<UserDto> user1 = userController.createUser(user);
        itemRequestController.create(1,itemRequest);
        ResponseEntity<ItemDto> createdItem = itemController.create(itemDto, Math.toIntExact(user1.getBody().getId()));
    ...
    void deleteTest() {
        ...
        assertEquals(0, itemController.getAll(1,0,10).getBody().size());
    }
    ...
    void getAllTest() {
        ...
        itemRequestController.create(1,itemRequest);
        ResponseEntity<ItemDto> createdItem = itemController.create(itemDto, Math.toIntExact(user1.getBody().getId()));
        ResponseEntity<ItemDto> createdItem2 = itemController.create(itemDto, Math.toIntExact(user1.getBody().getId()));
        assertEquals(2, itemController.getAll(1,0,10).getBody().size());
    }
